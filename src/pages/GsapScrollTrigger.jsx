...
const GsapScrollTrigger = () => {
		...
		() => {
			...
			boxes.forEach((box) => {
				gsap.to(box, {
					...
					scrollTrigger: {
						trigger: box,
						start: "bottom bottom", // when bottom of box hits the bottom of view port
						end: "top 20%", // end when top of box hits the 20% of view port
						scrub: true, // Animate while moving don't instantly complete it
					},
					ease: "power1.inOut",
				});
			});
	...
	return (
		<main>
			...
			<div className="mt-20 w-full h-screen overflow-hidden content-center" ref={scrollRef}>
